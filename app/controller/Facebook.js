Ext.define("PlayListApp.controller.Facebook", {
    ...
    onFacebookInit: function() {
        ...
        if (PlayListApp.app.facebookAppId == '') return;
        console.log(PlayListApp.app.facebookAppId);
        var me = this;

        FB.init({
            appId  : PlayListApp.app.facebookAppId,
            cookie : true
        });
        ...
        me.fbLoginTimeout = setTimeout(function() {
            ...
            Ext.create('Ext.MessageBox', {
                ...
                message: [
                    ...
                    'Check that your connected to internet properly.',
    ...
    login: function() {
        ...
        if (!splash) {
            Ext.Viewport.add({ xclass: 'PlayListApp.view.Login', id: 'login' });
        }
    ...
    onLogin: function() {
        ...
        var noteEditor = {
            xtype: "playeditorview"
        };
       
        Ext.Viewport.add([notesListContainer,noteEditor]);
        var fb=Ext.getCmp("signout");
        fb.setData({profileId:response});
       
        //Ext.Viewport.setActiveItem(fb);
        //var tpl=new Ext.XTemplate('<img src="https://graph.facebook.com/{profileId}/picture?type=square" />');
        
        //console.log(fb);
        //fb.add("profileId",response.id);            
                }
               //Ext.Viewport.setActiveItem(me.main);
                Ext.getStore('Plays').load();
            }
        });
    },
